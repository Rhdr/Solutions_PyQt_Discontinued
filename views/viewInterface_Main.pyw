...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnInsertEdit.setStyleSheet("Text-align:left")
        icon = QtGui.QIcon()
        ...
        self.btnShowHideRecords = QtWidgets.QPushButton(self.centralwidget)
        self.btnShowHideRecords.setStyleSheet("Text-align:left")
        self.btnShowHideRecords.setIcon(icon)
        self.btnShowHideRecords.setCheckable(True)
        self.btnShowHideRecords.setChecked(True)
        self.btnShowHideRecords.setObjectName("btnShowHideRecords")
        self.gridLayout.addWidget(self.btnShowHideRecords, 5, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnInsertEdit.setText(_translate("MainWindow", "New/Update Record"))
        self.btnShowHideRecords.setText(_translate("MainWindow", "Records"))
